...
public class LItemIronHammer {

    private static AdvancedItemStack itemStack;

    public static AdvancedItemStack getItem() {
        if(itemStack == null) {
            itemStack = new AdvancedItemStack(Material.IRON_PICKAXE);
            itemStack.setName("daslixou.lixoumining.litem.iron_hammer");
            itemStack.setNameAsTranslate("daslixou.lixoumining.litem.iron_hammer");
            itemStack.setMainID("daslixou.lixoumining.litem.iron_hammer");
            itemStack.setCustomID("daslixou.lixoumining.litem.iron_hammer");
            itemStack.setCustomModelData(15);
            itemStack.setAttackDamage(5);
    ...
    public static void createRecipe() {
        NamespacedKey key = new NamespacedKey(Main.getInstance(), "iron_hammer");
        ShapedRecipe recipe = new ShapedRecipe(key, getItem());
        recipe.shape("III", "III", " S ");
    ...
    public static String getBrokenName() {
        return "daslixou.lixoumining.litem.iron_hammer_broken";
    }
