...
public class LItemStoneHammer {

    private static AdvancedItemStack itemStack;

    public static AdvancedItemStack getItem() {
        if(itemStack == null) {
            itemStack = new AdvancedItemStack(Material.STONE_PICKAXE);
            itemStack.setName("daslixou.lixoumining.litem.stone_hammer");
            itemStack.setNameAsTranslate("daslixou.lixoumining.litem.stone_hammer");
            itemStack.setMainID("daslixou.lixoumining.litem.stone_hammer");
            itemStack.setCustomID("daslixou.lixoumining.litem.stone_hammer");
            itemStack.setCustomModelData(15);
            itemStack.setAttackDamage(4);
    ...
    public static void createRecipe() {
        NamespacedKey key = new NamespacedKey(Main.getInstance(), "stone_hammer");
        ShapedRecipe recipe = new ShapedRecipe(key, getItem());
        recipe.shape("CCC", "CCC", " S ");
    ...
    public static String getBrokenName() {
        return "daslixou.lixoumining.litem.stone_hammer_broken";
    }
